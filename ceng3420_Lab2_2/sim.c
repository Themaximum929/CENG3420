...
void handle_jalr(unsigned int cur_inst) {
    ...
    unsigned int rd = MASK11_7(cur_inst),
		rs1 = MASK19_15(cur_inst);
    int imm = sext(MASK31_20(cur_inst), 12);
    NEXT_LATCHES.PC = (sext(imm,12)+CURRENT_LATCHES.REGS[rs1]);
...
void handle_lh(unsigned int cur_inst) {
    ...
    unsigned int rd = MASK11_7(cur_inst), rs1 = MASK19_15(cur_inst);
    int imm12 = MASK31_20(cur_inst);
    NEXT_LATCHES.REGS[rd] = sext(
        (MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1] + 1]) << 8) + \
        MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]]),
        16
    );
...
void handle_lw(unsigned int cur_inst) {
    ...
    int imm12 = MASK31_20(cur_inst);
    NEXT_LATCHES.REGS[rd] = sext(
        (MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1] + 3]) << 24) + \
        (MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1] + 2]) << 16) + \
        (MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1] + 1]) << 8) + \
        MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]]),
        32
    );
...
void handle_sb(unsigned int cur_inst) {
     ...
     */
    unsigned int rs1 = MASK19_15(cur_inst), rs2 = MASK24_20(cur_inst);
    int imm12 = sext((MASK31(cur_inst) << 5) + MASK11_7(cur_inst), 12);
    MEMORY[CURRENT_LATCHES.REGS[rs1] + imm12] = MASK7_0(CURRENT_LATCHES.REGS[rs2]);
...
void handle_sh(unsigned int cur_inst) {
    ...
    int imm12 = sext((MASK31(cur_inst) << 5) + MASK11_7(cur_inst), 12);
    MEMORY[CURRENT_LATCHES.REGS[rs1] + imm12] = MASK7_0(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[CURRENT_LATCHES.REGS[rs1] + imm12 + 1] = MASK15_8(CURRENT_LATCHES.REGS[rs2]);
...
void handle_sw(unsigned int cur_inst) {
    ...
    MEMORY[CURRENT_LATCHES.REGS[rs1] + imm12] = MASK7_0(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[CURRENT_LATCHES.REGS[rs1] + imm12 + 1] = MASK15_8(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[CURRENT_LATCHES.REGS[rs1] + imm12 + 2] = MASK23_16(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[CURRENT_LATCHES.REGS[rs1] + imm12 + 3] = MASK31_24(CURRENT_LATCHES.REGS[rs2]);
