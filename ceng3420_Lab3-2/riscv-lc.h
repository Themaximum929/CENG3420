...
extern int CONTROL_STATE[CONTROL_STATE_ROWS][CONTROL_SIGNAL_BITS];
/* Main memory */
#define MEM_CYCLES 5
#define BYTES_IN_MEM 0x2000000
unsigned extern char MEMORY[BYTES_IN_MEM];
...
extern struct_system_latches CURRENT_LATCHES, NEXT_LATCHES;
...
extern int value_of_GatePC;
extern int value_of_GateMAR;
extern int value_of_GateMDR;
extern int value_of_GateALUSHF;
extern int value_of_GateRS2;
...
/* function.h */
unsigned extern int mask_val(int, int, int);
extern int sext_unit(int, int);
extern int rs2_mux(int, int, int);
extern int mar_mux(int, int, int);
extern int alu(int, int, int, int);
extern int addr2_mux(int, int, int, int, int);
extern int addr1_mux(int, int, int, int, int);
extern int logic_shift_20_function_unit(int);
extern int shift_function_unit(int, int, int, int);
extern int pc_mux(int, int, int);
extern int s_format_imm_gen_unit(int, int);
extern int b_format_imm_gen_unit(int, int, int, int);
extern int j_format_imm_gen_unit(int, int, int, int);
extern int mdr_mux(int, int, int);
extern int rs1_en(int, int);
extern int rs2_en(int, int);
extern int alu_shift_mux(int, int, int);
extern int blockBMUX(int, int, int);
extern int compare_function_unit(int, int, int, int);
extern int datasize_mux(unsigned int, int, int);
void write_memory(unsigned int, unsigned int, int);
extern int read_memory(unsigned int, unsigned int);
